# Programa: decodifica21.py
# Programador: Camila Budke
# Data: 28/04/2023

# Este programa decodifica uma mensagem usando uma frase codificada.
...
while i < tammensagem:
    ...
    novaDecod = ord(mensagem[i]) - (ord(palavra[i % tampalavra]) - 64) # Para B: 66 - (65-64) = 65
