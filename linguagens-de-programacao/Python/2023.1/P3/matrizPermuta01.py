...
# Este programa lê uma matrize de tamanho n x n, e imprime P caso a
# matriz seja de permutação e N caso contrário.
...
# Passo 1. Leia e crie a matriz de entrada
...
while i < n and permutacao:
    for i in range(n):
        ...
        # Passo 2.2.1. Para linha i e coluna j faça:
        for j in range(n):
